...
const MovieCard = ({ movie }) => {
  return (
    <Link href={`/movie/${movie.id}`} passHref>
      <div className="bg-white text-left bg-opacity-10 text-white rounded-md cursor-pointer rounded-2xl p-2 transition hover:-translate-y-1 hover:border  hover:border-red-700 hover:duration-300">
