...
const Movie = ({ movie }) => {
  return (
    <div className="container max-w-4xl mx-auto pt-6 text-white opacity-90">
      <Meta title={movie.title} />
      <div className="px-3">
        <Image src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} width={1000} height={600} className="rounded-2xl" alt={movie.title} />
